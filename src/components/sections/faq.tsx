    ...
    <section id="faq" className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
          <div className="inline-flex items-center justify-center size-16 rounded-full bg-red-light mb-6">
            <Question className="size-8 text-red-primary" weight="duotone" />
          </div>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {FAQ_ITEMS.map((item, index) => (
              <AccordionItem
                key={item.id}
                value={item.id}
                className="bg-red-bg border-0 rounded-xl px-6 data-[state=open]:bg-red-light"
              >
