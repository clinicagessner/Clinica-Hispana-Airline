...
export const SERVICES: Service[] = [
  {
    ...
    title: "Médico de Familia en Houston TX | Medicina Familiar Hispana",
    shortTitle: "Familiar",
    description: "Médico de familia en Houston TX con atención 100% en español. Medicina familiar para toda la familia, desde niños hasta adultos mayores. Walk-in, sin seguro, precios accesibles. Llame: (346) 626-4110",
    longDescription: "Servicio de medicina familiar en Houston TX con atención 100% en español. En Clínica Hispana Airline ofrecemos atención médica completa y continua para pacientes de todas las edades, desde recién nacidos hasta adultos mayores. Como su médico de familia hispano en Houston, nos enfocamos en la prevención, diagnóstico y tratamiento de enfermedades comunes y crónicas.\n\nAtendemos sin cita previa en nuestra clínica ubicada en 934 E Tidwell Rd, Houston TX 77022, aceptamos pacientes con o sin seguro médico, y mantenemos un historial médico completo de cada miembro de su familia.\n\n**¿Qué incluye nuestra consulta de medicina familiar en Houston?**\n\nDurante su visita, nuestro médico realizará un examen físico completo, revisión de signos vitales (presión arterial, temperatura, peso, pulso), evaluación de síntomas actuales, y diagnóstico profesional. Si es necesario, se prescribirá medicamento y se ordenarán estudios de laboratorio con resultados el mismo día en nuestra clínica.\n\n**Condiciones que tratamos como médico general en Houston:**\n\n- Resfriados, gripe e infecciones respiratorias\n- Dolor de garganta, otitis e infecciones del oído\n- Sinusitis y problemas de los senos paranasales\n- Alergias estacionales y crónicas\n- Dolores musculares, articulares y de espalda\n- Problemas digestivos y dolor abdominal\n- Control de presión arterial y glucosa\n- Chequeos preventivos anuales\n- Vacunas para niños y adultos\n- Tratamiento de heridas menores\n\n**Medicina familiar para toda la familia hispana de Houston**\n\nNuestro doctor de familia atiende a todos los miembros de su familia bajo el mismo techo: niños, adolescentes, adultos y adultos mayores. Esto facilita el seguimiento de la salud familiar, especialmente cuando hay condiciones hereditarias como diabetes o hipertensión. Como clínica hispana en Houston, entendemos las particularidades culturales, alimenticias y de estilo de vida de nuestra comunidad.\n\n**Atención preventiva y chequeos anuales**\n\nLa medicina preventiva es la base de una vida saludable. Ofrecemos chequeos anuales completos, tamizaje de enfermedades crónicas (diabetes, hipertensión, colesterol), y consejería en estilo de vida saludable. Detectar problemas a tiempo le ahorra tratamientos costosos en el futuro.\n\n**¿Por qué elegir Clínica Hispana Airline para su médico de familia?**\n\nNuestro equipo médico habla español al 100%, entiende las necesidades de la comunidad hispana de Houston, y ofrece precios accesibles sin comprometer la calidad de atención. Contamos con laboratorio en sitio, farmacia genérica accesible, y horario extendido para que pueda visitarnos cuando lo necesite. Ubicados en 934 E Tidwell Rd, Houston TX 77022, con amplio estacionamiento gratuito y fácil acceso desde el norte de Houston.",
    titleEn: "Family Doctor in Houston TX | Hispanic Family Medicine Clinic",
    descriptionEn: "Family doctor in Houston TX with 100% Spanish-speaking staff. Family medicine for all ages, from newborns to seniors. Walk-ins welcome, uninsured accepted, affordable pricing. Call: (346) 626-4110",
    longDescriptionEn: "Family medicine practice in Houston TX with 100% Spanish-speaking staff. At Clínica Hispana Airline, we provide complete and continuous medical care for patients of all ages, from newborns to the elderly. As your Hispanic family doctor in Houston, we focus on prevention, diagnosis, and treatment of common and chronic conditions.\n\nWe welcome walk-in patients at our clinic located at 934 E Tidwell Rd, Houston TX 77022. We accept patients with or without health insurance and maintain a complete medical history for every member of your family.\n\n**What does a family medicine visit in Houston include?**\n\nDuring your visit, our physician will perform a thorough physical examination, review your vital signs (blood pressure, temperature, weight, and pulse), assess your current symptoms, and provide a professional diagnosis. When needed, prescriptions and same-day lab orders are available on-site.\n\n**Conditions we treat as your general practitioner in Houston:**\n\n- Colds, flu, and respiratory infections\n- Sore throat, ear infections, and otitis\n- Sinusitis and sinus problems\n- Seasonal and chronic allergies\n- Muscle, joint, and back pain\n- Digestive issues and abdominal pain\n- Blood pressure and blood sugar management\n- Annual preventive checkups\n- Vaccines for children and adults\n- Minor wound treatment\n\n**Family medicine for the entire Hispanic family in Houston**\n\nOur family doctor treats all members of your family under one roof: children, teens, adults, and seniors. This facilitates family health monitoring, especially when there are hereditary conditions such as diabetes or hypertension. As a Hispanic clinic in Houston, we understand the cultural, dietary, and lifestyle particularities of our community.\n\n**Preventive care and annual checkups**\n\nPreventive medicine is the foundation of a healthy life. We offer comprehensive annual checkups, screening for chronic diseases (diabetes, hypertension, cholesterol), and healthy lifestyle counseling. Detecting problems early saves you costly treatments in the future.\n\n**Why choose Clínica Hispana Airline as your family doctor?**\n\nOur medical team speaks 100% Spanish, understands the needs of Houston's Hispanic community, and offers affordable pricing without compromising care quality. We have on-site laboratory services, accessible generic pharmacy, and extended hours so you can visit us when you need to. Located at 934 E Tidwell Rd, Houston TX 77022, with ample free parking and easy access from north Houston.",
    icon: "Stethoscope",
    image: "/images/services/family-medicine.webp",
    category: "especial",
    keywords: [
      "medicina familiar Houston",
      "médico de familia Houston",
      "doctor familia hispano Houston",
      "médico general Houston español",
      "medicina familiar cerca de mí",
      "doctor que habla español Houston",
      "médico hispano Houston",
      "consultorio médico hispano Houston",
      "clínica medicina familiar Houston TX",
      "médico de familia sin seguro Houston",
      "doctor familia walk in Houston",
      "médico bilingüe Houston",
      "chequeo médico anual Houston",
      "medicina preventiva Houston español",
      "médico de cabecera Houston",
    ],
    keywordsEn: [
      "family medicine Houston",
      "family doctor Houston TX",
      "Hispanic family doctor Houston",
      "general practitioner Houston Spanish",
      "Spanish speaking doctor Houston",
      "bilingual family doctor Houston",
      "walk in family doctor Houston",
      "primary care Houston Hispanic",
      "family medicine clinic Houston TX",
      "uninsured family doctor Houston",
      "annual physical Houston Spanish",
    ],
    features: [
      "Atención para todas las edades",
      "Médico 100% en español",
      "Sin cita previa necesaria",
      "Aceptamos pacientes sin seguro",
      "Laboratorio con resultados el mismo día",
    ...
    featuresEn: [
      "Care for all ages",
      "100% Spanish-speaking doctor",
      "No appointment needed",
      "Uninsured patients welcome",
      "Same-day lab results",
      "Complete medical history",
      "Preventive checkups & vaccines",
  ...
  },
  {
    ...
    title: "Examen I-693 Houston | Civil Surgeon USCIS Hispano",
    shortTitle: "Inmigración",
    description: "Examen médico de inmigración I-693 en Houston con Civil Surgeons certificados por USCIS. Formulario completo el mismo día, vacunas en sitio, atención en español. Sin cita previa.",
    longDescription: "¿Necesita el examen médico de inmigración I-693 para su Green Card en Houston? En Clínica Hispana Airline contamos con Civil Surgeons certificados por USCIS que completan el formulario oficial con precisión y rapidez. Somos expertos en exámenes de inmigración en Houston TX y entendemos la importancia de completar el formulario correctamente desde la primera visita.\n\n**¿Qué incluye el examen médico I-693?**\n\nEl examen de inmigración es un requisito obligatorio para obtener la residencia permanente (Green Card) en Estados Unidos. Durante su visita, nuestro Civil Surgeon realizará:\n\n- Examen físico completo\n- Revisión de historial médico y vacunas\n- Prueba de tuberculosis (TB test)\n- Análisis de sangre requeridos por USCIS\n- Aplicación de vacunas faltantes según el calendario de inmunización de CDC\n- Llenado completo y firma del formulario I-693\n\n**¿Qué documentos necesita traer?**\n\n- Identificación válida con foto (pasaporte, ID estatal o licencia)\n- Récord de vacunas previas (si los tiene disponibles)\n- Formulario I-693 en blanco (nosotros también podemos proporcionarlo)\n\n**¿Cuánto tiempo toma el proceso?**\n\nEn la mayoría de los casos, completamos el examen y el formulario I-693 en una sola visita. Los resultados de laboratorio y el formulario firmado están listos el mismo día, para que pueda enviarlo a USCIS sin demoras.\n\n**¿Por qué elegir Clínica Hispana Airline para su examen I-693?**\n\nNuestros Civil Surgeons tienen experiencia con el proceso de inmigración y completan el formulario correctamente, ayudándole a evitar rechazos administrativos. Atención 100% en español, vacunas requeridas disponibles en la clínica, y precios competitivos. Ubicados en 934 E Tidwell Rd, Houston TX 77022, con amplio estacionamiento gratuito.",
    titleEn: "I-693 Exam Houston | USCIS Civil Surgeon Hispanic Clinic",
    descriptionEn: "I-693 immigration medical exam in Houston with USCIS-certified Civil Surgeons. Complete form same day, on-site vaccines, Spanish-speaking staff. Walk-ins welcome.",
    longDescriptionEn: "Need an I-693 immigration medical exam for your Green Card in Houston? At Clínica Hispana Airline, our USCIS-certified Civil Surgeons complete the official I-693 form accurately and efficiently. We specialize in immigration physicals in Houston TX and understand how important it is to complete the form correctly from the first visit.\n\n**What does the I-693 immigration medical exam include?**\n\nThe immigration physical is a mandatory requirement to obtain permanent residency (Green Card) in the United States. During your visit, our Civil Surgeon will perform:\n\n- Complete physical examination\n- Medical history and vaccination record review\n- Tuberculosis (TB) test\n- Required blood tests per USCIS guidelines\n- Administration of any missing vaccines per CDC immunization schedule\n- Complete completion and signing of Form I-693\n\n**What documents should you bring?**\n\n- Valid government-issued photo ID (passport, state ID, or driver's license)\n- Previous vaccination records (if available)\n- Blank Form I-693 (we can also provide one for you)\n\n**How long does the process take?**\n\nIn most cases, we complete the exam and Form I-693 in a single visit. Lab results and the signed form are ready the same day, so you can submit your application to USCIS without delay.\n\n**Why choose Clínica Hispana Airline for your I-693 exam?**\n\nOur Civil Surgeons have experience with the immigration process and complete the form correctly, helping you avoid administrative rejections. Full Spanish-language service, required vaccines on-site, and competitive pricing. Located at 934 E Tidwell Rd, Houston TX 77022, with ample free parking.",
    icon: "FileText",
    image: "/images/services/immigration.webp",
    category: "especial",
    keywords: [
      "examen médico inmigración Houston",
      "examen I-693 Houston",
      "Civil Surgeon Houston USCIS",
      "médico USCIS Houston español",
      "examen Green Card Houston",
      "examen residencia permanente Houston",
      "médico inmigración hispano Houston",
      "I-693 Houston Civil Surgeon",
      "vacunas inmigración Houston",
      "examen físico residencia Houston",
    ],
    keywordsEn: [
      "immigration medical exam Houston",
      "I-693 Houston TX",
      "USCIS civil surgeon Houston",
      "civil surgeon Houston Spanish",
      "Green Card medical exam Houston",
      "immigration doctor Houston Hispanic",
      "permanent residency exam Houston",
      "I-693 Civil Surgeon Houston",
      "immigration vaccines Houston",
      "USCIS approved doctor Houston",
    ],
    features: [
      "Civil Surgeons certificados USCIS",
      "Formulario I-693 completo el mismo día",
      "Vacunas requeridas disponibles en sitio",
      "Resultados de laboratorio el mismo día",
      "Atención 100% en español",
      "Precios competitivos y transparentes",
    ],
    featuresEn: [
      "USCIS-certified Civil Surgeons",
      "Complete I-693 form same day",
      "Required vaccines available on-site",
      "Same-day lab results",
  ...
  },
  {
    ...
    title: "Control de Diabetes e Hipertensión Houston | Clínica Hispana",
    shortTitle: "Crónicas",
    description: "Control de diabetes, hipertensión, colesterol y tiroides en Houston TX. Médico que habla español, ajuste de medicamentos y educación 100% en español. Sin cita previa.",
    longDescription: "Programa integral para el control de diabetes e hipertensión en Houston TX. La diabetes tipo 2, presión arterial alta y colesterol alto son condiciones crónicas comunes en la comunidad hispana. En Clínica Hispana Airline ofrecemos un programa de seguimiento continuo con médicos que hablan español para ayudarle a controlar su salud y prevenir complicaciones a largo plazo.\n\n**¿Qué incluye nuestro programa de control de enfermedades crónicas en Houston?**\n\n- Monitoreo regular de glucosa en sangre y hemoglobina A1C\n- Medición y control de presión arterial alta\n- Panel completo de colesterol y triglicéridos\n- Evaluación de función renal y hepática\n- Ajuste personalizado de medicamentos según sus niveles\n- Educación en español sobre alimentación saludable\n- Plan de seguimiento con visitas programadas\n- Laboratorio clínico en sitio con resultados el mismo día\n\n**Control de diabetes en Houston: prevención de complicaciones**\n\nLa diabetes no controlada puede causar daño a los riñones, pérdida de visión, problemas de circulación, neuropatía y enfermedad cardiovascular. En nuestra clínica hispana de Houston, su médico monitorea su hemoglobina A1C de forma regular y ajusta su tratamiento de diabetes para mantener sus niveles de azúcar en sangre dentro del rango saludable. Atendemos pacientes con diabetes tipo 2 recién diagnosticada, así como pacientes que ya están en tratamiento con medicamentos orales o insulina.\n\n**Hipertensión arterial: el enemigo silencioso**\n\nLa presión arterial alta generalmente no presenta síntomas pero aumenta el riesgo de ataque cardíaco, derrame cerebral e insuficiencia renal. Nuestro equipo médico en Houston monitorea su presión en cada visita, ajusta su tratamiento antihipertensivo según sus necesidades, y le enseña a tomar su presión correctamente en casa. Le ayudamos a entender qué números son normales y cuándo es necesario buscar atención médica urgente.\n\n**Colesterol y triglicéridos**\n\nEl colesterol alto es un factor de riesgo cardiovascular importante. Realizamos panel lipídico completo (colesterol total, HDL, LDL y triglicéridos), recomendamos cambios alimenticios apropiados a su cultura y preferencias, y prescribimos medicamentos cuando es médicamente necesario.\n\n**Tiroides: hipotiroidismo e hipertiroidismo**\n\nLos problemas de tiroides afectan el metabolismo, peso, energía y estado de ánimo. Realizamos pruebas completas de función tiroidea (TSH, T3, T4 libre) y ajustamos los medicamentos para tiroides según sus resultados de laboratorio.\n\n**¿Por qué elegir nuestra clínica hispana en Houston para el control de diabetes?**\n\nNuestro equipo médico habla español al 100% y entiende los factores culturales y alimenticios de la comunidad hispana. Ofrecemos educación en un idioma que usted comprende completamente, laboratorio clínico en sitio con resultados el mismo día, precios accesibles para pacientes con o sin seguro médico, y horario extendido (Lunes a Domingo, 9:00 AM - 9:00 PM) para que no tenga que faltar al trabajo. Nuestra clínica está ubicada en 934 E Tidwell Rd, Houston TX 77022, con amplio estacionamiento gratuito y fácil acceso desde el norte de Houston.",
    titleEn: "Diabetes & Hypertension Management Houston | Hispanic Clinic",
    descriptionEn: "Diabetes, hypertension, cholesterol and thyroid management in Houston TX. Spanish-speaking diabetes doctor, A1C monitoring, medication adjustments and patient education. Walk-ins welcome.",
    longDescriptionEn: "Comprehensive chronic condition management program in Houston TX. Type 2 diabetes, high blood pressure, and high cholesterol are common conditions in the Hispanic community. At Clínica Hispana Airline, we provide a structured ongoing monitoring program with Spanish-speaking doctors to help you take control of your health and prevent long-term complications.\n\n**What our chronic condition program in Houston includes:**\n\n- Regular blood glucose and hemoglobin A1C monitoring\n- Blood pressure measurement and control\n- Complete cholesterol and triglyceride panel testing\n- Kidney and liver function evaluation\n- Personalized medication adjustments based on your levels\n- Patient education in Spanish on healthy eating\n- Scheduled follow-up visits and care plan\n- On-site clinical lab with same-day results\n\n**Diabetes management in Houston: preventing complications**\n\nUncontrolled diabetes can cause kidney damage, vision loss, poor circulation, neuropathy, and cardiovascular disease. At our Hispanic clinic in Houston, your doctor regularly monitors your hemoglobin A1C and adjusts your diabetes treatment to keep your blood sugar levels within a healthy range. We treat patients with newly diagnosed type 2 diabetes as well as patients already on oral medications or insulin.\n\n**Hypertension: the silent threat**\n\nHigh blood pressure typically presents no symptoms yet increases the risk of heart attack, stroke, and kidney failure. Our medical team in Houston checks your blood pressure at every visit, adjusts your antihypertensive treatment as needed, and teaches you how to measure your blood pressure correctly at home. We help you understand what numbers are normal and when to seek urgent care.\n\n**High cholesterol and triglycerides**\n\nHigh cholesterol is an important cardiovascular risk factor. We perform complete lipid panels (total cholesterol, HDL, LDL, and triglycerides), recommend dietary changes appropriate to your culture and preferences, and prescribe medications when medically necessary.\n\n**Thyroid: hypothyroidism and hyperthyroidism**\n\nThyroid problems affect metabolism, weight, energy, and mood. We perform complete thyroid function testing (TSH, T3, free T4) and adjust thyroid medications based on your lab results.\n\n**Why choose our Hispanic clinic in Houston for diabetes management?**\n\nOur medical team speaks 100% Spanish and understands the cultural and dietary factors of the Hispanic community. We offer education in a language you fully understand, on-site lab services with same-day results, affordable pricing for patients with or without insurance, and extended hours (Monday to Sunday, 9:00 AM - 9:00 PM) so you never have to miss work. Our clinic is located at 934 E Tidwell Rd, Houston TX 77022, with ample free parking and easy access from north Houston.",
    icon: "Heart",
    image: "/images/services/chronic-conditions.jpg",
    category: "especialidad",
    keywords: [
      "control diabetes Houston",
      "diabetólogo Houston español",
      "médico diabetes hispano Houston",
      "manejo de diabetes Houston TX",
      "hipertensión Houston",
      "presión alta Houston clínica",
      "control hipertensión Houston",
      "colesterol alto Houston",
      "tiroides Houston español",
      "endocrinólogo hispano Houston",
      "A1C Houston español",
      "azúcar alta Houston clínica",
      "diabetes tipo 2 Houston",
      "condiciones crónicas Houston",
      "enfermedades crónicas Houston español",
    ],
    keywordsEn: [
      "diabetes management Houston",
      "diabetes doctor Houston Spanish",
      "hypertension doctor Houston TX",
      "high blood pressure treatment Houston",
      "cholesterol management Houston",
      "thyroid doctor Houston Spanish",
      "endocrinologist Houston Hispanic",
      "A1C testing Houston",
      "type 2 diabetes Houston",
      "chronic conditions clinic Houston",
      "Spanish speaking diabetes doctor Houston",
    ],
    features: [
      "Monitoreo de glucosa y A1C",
      "Control de presión arterial",
      "Manejo de colesterol y triglicéridos",
      "Pruebas de tiroides (TSH, T3, T4)",
      "Ajuste personalizado de medicamentos",
      "Educación nutricional en español",
      "Laboratorio con resultados el mismo día",
    ...
    featuresEn: [
      ...
      "Nutritional education in Spanish",
      "Same-day lab results",
  ...
  },
  {
    ...
    description: "Laboratorio clínico en Houston TX con resultados el mismo día. Análisis de sangre, glucosa, colesterol, hemograma, tiroides, función renal y más. Sin cita previa, atención en español. Llame: (346) 626-4110",
    longDescription: "Laboratorio clínico en Houston TX con análisis de sangre y resultados el mismo día. En Clínica Hispana Airline contamos con un laboratorio equipado con tecnología moderna para análisis rápidos y precisos. Esto significa que su médico puede ordenar y revisar sus resultados durante la misma visita, sin que tenga que regresar otro día.\n\nAtendemos sin cita previa en nuestra clínica ubicada en 934 E Tidwell Rd, Houston TX 77022. Aceptamos pacientes con o sin seguro médico, ofrecemos precios accesibles y transparentes, y todo nuestro personal habla español.\n\n**Pruebas de laboratorio disponibles en Houston:**\n\n- Hemograma completo (CBC) — análisis general de la sangre\n- Glucosa en ayunas y hemoglobina A1C — control de diabetes\n- Panel de colesterol y lípidos (HDL, LDL, triglicéridos)\n- Panel metabólico completo (CMP)\n- Función tiroidea (TSH, T3, T4 libre)\n- Función hepática (enzimas del hígado)\n- Función renal (creatinina, BUN)\n- Análisis de orina completo\n- Prueba de embarazo en sangre y orina\n- Ácido úrico\n- Vitamina D y vitamina B12\n- Panel de hierro y ferritina\n- Pruebas de ETS (VIH, hepatitis, sífilis, gonorrea, clamidia)\n- Pruebas de detección de infecciones urinarias\n\n**Análisis de sangre en Houston: ¿cómo funciona el proceso?**\n\nPuede visitar nuestro laboratorio sin cita previa. Nuestro personal capacitado realiza la toma de muestra de sangre de forma rápida y profesional, minimizando cualquier molestia. Para pruebas de glucosa, colesterol y lípidos generalmente se recomienda ayuno previo, pero le indicaremos las instrucciones específicas según las pruebas que necesite. Los resultados están disponibles el mismo día en la mayoría de los casos comunes.\n\n**¿Para qué sirven los análisis de sangre?**\n\nLos exámenes de laboratorio son fundamentales para la salud preventiva. Permiten detectar condiciones antes de que presenten síntomas (como diabetes, anemia o problemas de tiroides), monitorear enfermedades crónicas (diabetes, hipertensión, colesterol alto), evaluar el funcionamiento de órganos vitales (hígado, riñones, corazón) y tomar decisiones médicas informadas sobre su tratamiento.\n\n**Laboratorio en la clínica: la ventaja para usted**\n\nA diferencia de laboratorios externos en Houston que requieren cita previa, traslados adicionales y entrega de resultados en varios días, nuestro laboratorio está dentro de la clínica. Esto significa:\n\n- Una sola visita para consulta + laboratorio\n- Su médico ve sus resultados el mismo día\n- Ajustes de tratamiento inmediatos cuando sea necesario\n- Sin necesidad de coordinar entre laboratorio y consultorio\n- Menos tiempo perdido y menos estrés\n\n**Pruebas de laboratorio sin seguro médico en Houston**\n\nMuchos pacientes hispanos en Houston posponen los análisis de sangre por temor a los costos. En nuestra clínica ofrecemos precios accesibles para pacientes sin seguro médico, con tarifas transparentes que le informamos antes de realizar cualquier prueba. La salud preventiva no debe ser un lujo.\n\n**¿Por qué elegir el laboratorio de Clínica Hispana Airline?**\n\nNuestro laboratorio clínico en Houston combina tecnología moderna, atención 100% en español, precios accesibles y resultados el mismo día. Nuestro personal entiende la importancia de un trato cálido y respetuoso, especialmente para pacientes que pueden tener miedo a las agujas o ansiedad por sus resultados. Ubicados en 934 E Tidwell Rd, Houston TX 77022, con amplio estacionamiento gratuito y fácil acceso desde el norte de Houston.",
    titleEn: "Clinical Laboratory Houston | Same-Day Results",
    descriptionEn: "Clinical laboratory in Houston TX with same-day results. Blood tests, glucose, cholesterol, CBC, thyroid panels, kidney function and more. Walk-ins welcome, Spanish-speaking staff. Call: (346) 626-4110",
    longDescriptionEn: "Clinical laboratory in Houston TX with blood tests and same-day results. At Clínica Hispana Airline, we have an in-clinic laboratory equipped with modern technology for fast and accurate analysis. This means your doctor can order and review your results during the same visit, without you having to return another day.\n\nWe welcome walk-in patients at our clinic located at 934 E Tidwell Rd, Houston TX 77022. We accept patients with or without health insurance, offer affordable and transparent pricing, and our entire staff speaks Spanish.\n\n**Lab tests available in Houston:**\n\n- Complete blood count (CBC) — general blood analysis\n- Fasting glucose and hemoglobin A1C — diabetes monitoring\n- Cholesterol and lipid panel (HDL, LDL, triglycerides)\n- Comprehensive metabolic panel (CMP)\n- Thyroid function (TSH, T3, free T4)\n- Liver function (liver enzymes)\n- Kidney function (creatinine, BUN)\n- Complete urinalysis\n- Blood and urine pregnancy tests\n- Uric acid\n- Vitamin D and vitamin B12\n- Iron and ferritin panel\n- STD testing (HIV, hepatitis, syphilis, gonorrhea, chlamydia)\n- Urinary tract infection screening\n\n**Blood tests in Houston: how the process works**\n\nYou can visit our laboratory without an appointment. Our trained staff performs blood draws quickly and professionally, minimizing any discomfort. For glucose, cholesterol, and lipid tests, fasting is generally recommended; we'll provide specific instructions based on your tests. Results are available the same day for most common cases.\n\n**Why do blood tests matter?**\n\nLab tests are essential for preventive health. They allow us to detect conditions before symptoms appear (such as diabetes, anemia, or thyroid problems), monitor chronic diseases (diabetes, hypertension, high cholesterol), evaluate the function of vital organs (liver, kidneys, heart), and make informed medical decisions about your treatment.\n\n**In-clinic laboratory: the advantage for you**\n\nUnlike external labs in Houston that require appointments, additional trips, and deliver results over several days, our laboratory is located inside the clinic. This means:\n\n- A single visit for consultation + lab work\n- Your doctor sees your results the same day\n- Immediate treatment adjustments when needed\n- No coordination needed between lab and clinic\n- Less time wasted and less stress\n\n**Lab tests without health insurance in Houston**\n\nMany Hispanic patients in Houston delay blood tests due to cost concerns. At our clinic, we offer affordable pricing for uninsured patients, with transparent rates we share with you before performing any test. Preventive healthcare should not be a luxury.\n\n**Why choose Clínica Hispana Airline's laboratory?**\n\nOur clinical laboratory in Houston combines modern technology, 100% Spanish-language care, affordable pricing, and same-day results. Our staff understands the importance of warm and respectful treatment, especially for patients who may have fear of needles or anxiety about their results. Located at 934 E Tidwell Rd, Houston TX 77022, with ample free parking and easy access from north Houston.",
    icon: "Flask",
    image: "/images/services/laboratory.webp",
    category: "diagnostico",
    keywords: [
      "laboratorio clínico Houston",
      "análisis de sangre Houston español",
      "examen de sangre Houston",
      "prueba de glucosa Houston",
      "hemograma Houston",
      "panel lipídico Houston",
      "pruebas de tiroides Houston español",
      "laboratorio sin seguro Houston",
      "laboratorio walk in Houston",
      "análisis clínicos Houston hispano",
      "laboratorio cerca de mí Houston",
      "examen de colesterol Houston",
      "prueba de embarazo Houston",
      "función renal Houston laboratorio",
      "resultados el mismo día Houston",
    ],
    keywordsEn: [
      "clinical laboratory Houston",
      "blood test Houston TX",
      "blood test Houston Spanish",
      "same-day lab results Houston",
      "glucose test Houston",
      "lipid panel Houston",
      "thyroid testing Houston",
      "uninsured lab tests Houston",
      "walk in lab Houston",
      "lab tests near me Houston",
      "Hispanic clinical laboratory Houston",
    ],
    features: [
  ...
  },
  {
    id: "ginecologia",
    slug: "ginecologia",
    title: "Ginecología en Houston | Salud de la Mujer Hispana",
    shortTitle: "Ginecología",
    description: "Servicios de ginecología en Houston TX en español. Papanicolaou, examen pélvico, examen de seno, control prenatal e infecciones vaginales. Sin cita previa, ambiente confidencial. Llame: (346) 626-4110",
    longDescription: "Servicios de ginecología en Houston TX con atención 100% en español para la salud integral de la mujer hispana. En Clínica Hispana Airline brindamos atención confidencial y respetuosa para mujeres en todas las etapas de su vida: adolescencia, edad reproductiva, embarazo, premenopausia y menopausia.\n\nAtendemos sin cita previa en nuestra clínica ubicada en 934 E Tidwell Rd, Houston TX 77022. Aceptamos pacientes con o sin seguro médico y ofrecemos precios accesibles para la comunidad hispana de Houston.\n\n**Servicios de ginecología que ofrecemos en Houston:**\n\n- Examen de Papanicolaou (Pap smear)\n- Examen clínico de seno\n- Examen pélvico completo y tratamiento de infecciones vaginales\n- Evaluación de irregularidades menstruales\n- Consulta de menopausia y manejo de síntomas\n- Atención prenatal básica\n- Pruebas de embarazo y consejería\n- Detección de VPH (Virus del Papiloma Humano)\n- Tratamiento de candidiasis y vaginosis bacteriana\n- Orientación en planificación familiar\n\n**Examen de Papanicolaou en Houston: detección temprana del cáncer cervical**\n\nEl Papanicolaou es uno de los exámenes preventivos más importantes para la mujer. Permite detectar cambios celulares en el cuello uterino antes de que se conviertan en cáncer. En nuestra clínica hispana de Houston realizamos este examen de forma rápida, en un ambiente cómodo y privado, con resultados que llegan a su consulta. Su médico le recomendará la frecuencia adecuada del examen según sus antecedentes personales y las guías médicas vigentes.\n\n**Atención prenatal básica en Houston**\n\nSi sospecha o sabe que está embarazada, podemos confirmar su embarazo, realizar análisis iniciales, brindarle orientación sobre los primeros meses, y referirla a un obstetra de confianza para el control prenatal completo. Ofrecemos consejería en español para que entienda cada paso del proceso.\n\n**Tratamiento de infecciones vaginales y urinarias**\n\nLas infecciones vaginales (candidiasis, vaginosis bacteriana, tricomoniasis) y las infecciones urinarias son frecuentes y pueden ser muy molestas. Realizamos diagnóstico el mismo día con análisis en sitio, y prescribimos el tratamiento apropiado. No tiene que vivir con incomodidad.\n\n**Salud de la mujer hispana en cada etapa**\n\nYa sea que esté buscando información sobre anticoncepción, planificando un embarazo, experimentando síntomas de menopausia (sofocos, cambios de humor, sequedad), o simplemente necesite su chequeo ginecológico anual, nuestro equipo en Houston le brinda la atención que necesita en un ambiente de confianza.\n\n**Atención confidencial y respetuosa para la mujer hispana**\n\nEntendemos que los temas de salud femenina pueden sentirse sensibles, especialmente en nuestra cultura. En Clínica Hispana Airline cada consulta es privada y confidencial, y nuestro personal está capacitado para hacerle sentir cómoda y respetada. Estamos ubicados en 934 E Tidwell Rd, Houston TX 77022, con amplio estacionamiento gratuito y fácil acceso desde el norte de Houston.",
    titleEn: "Gynecology in Houston | Hispanic Women's Health Clinic",
    descriptionEn: "Women's gynecology services in Houston TX in Spanish. Pap smears, pelvic exams, breast exams, basic prenatal care and vaginal infections. Walk-ins welcome, confidential setting. Call: (346) 626-4110",
    longDescriptionEn: "Gynecology services in Houston TX with 100% Spanish-speaking care for the integral health of Hispanic women. At Clínica Hispana Airline, we provide confidential and respectful care for women at every stage of life: adolescence, reproductive years, pregnancy, perimenopause, and menopause.\n\nWe welcome walk-in patients at our clinic located at 934 E Tidwell Rd, Houston TX 77022. We accept patients with or without health insurance and offer affordable pricing for Houston's Hispanic community.\n\n**Gynecology services we offer in Houston:**\n\n- Pap smear (cervical cancer screening)\n- Clinical breast exam\n- Complete pelvic exam\n- Diagnosis and treatment of vaginal infections\n- Evaluation of irregular periods\n- Menopause consultation and symptom management\n- Basic prenatal care\n- Pregnancy testing and counseling\n- HPV (Human Papillomavirus) screening\n- Treatment of candidiasis and bacterial vaginosis\n- Family planning guidance\n\n**Pap smear in Houston: early detection of cervical cancer**\n\nThe Pap smear is one of the most important preventive screenings for women. It detects cellular changes in the cervix before they become cancerous. At our Hispanic clinic in Houston, we perform this exam quickly, in a comfortable and private environment, with results delivered to your follow-up appointment. Your doctor will recommend the appropriate frequency based on your personal history and current medical guidelines.\n\n**Basic prenatal care in Houston**\n\nIf you suspect or know you're pregnant, we can confirm your pregnancy, perform initial laboratory tests, provide guidance for the first months, and refer you to a trusted obstetrician for complete prenatal care. We offer counseling in Spanish so you understand every step of the process.\n\n**Treatment of vaginal and urinary infections**\n\nVaginal infections (candidiasis, bacterial vaginosis, trichomoniasis) and urinary tract infections are common and can be very uncomfortable. We perform same-day diagnosis with on-site analysis and prescribe appropriate treatment. You don't have to live with discomfort.\n\n**Hispanic women's health at every stage**\n\nWhether you're looking for information on birth control, planning a pregnancy, experiencing menopause symptoms (hot flashes, mood changes, dryness), or simply need your annual gynecology checkup, our Houston team provides the care you need in a trusting environment.\n\n**Confidential and respectful care for Hispanic women**\n\nWe understand that women's health topics can feel sensitive, especially in our culture. At Clínica Hispana Airline, every visit is private and confidential, and our staff is trained to make you feel comfortable and respected. We're located at 934 E Tidwell Rd, Houston TX 77022, with ample free parking and easy access from north Houston.",
    icon: "GenderFemale",
    image: "/images/services/gynecology.webp",
    category: "mujer",
    keywords: [
      "ginecología Houston",
      "ginecólogo español Houston",
      "ginecóloga hispana Houston",
      "Papanicolaou Houston",
      "papanicolaou en español Houston",
      "examen pélvico Houston",
      "salud mujer Houston español",
      "clínica ginecológica hispana Houston",
      "control prenatal Houston español",
      "atención prenatal Houston hispano",
      "infección vaginal Houston tratamiento",
      "candidiasis Houston clínica",
      "menopausia Houston español",
      "examen de seno Houston",
      "VPH Houston detección",
    ],
    keywordsEn: [
      "gynecology Houston TX",
      "Hispanic gynecologist Houston",
      "Spanish speaking gynecologist Houston",
      "Pap smear Houston",
      "women's health clinic Houston Spanish",
      "OB GYN Houston Hispanic",
      "pelvic exam Houston",
      "prenatal care Houston Spanish",
      "vaginal infection treatment Houston",
      "menopause clinic Houston Spanish",
      "HPV screening Houston",
    ],
    features: [
      ...
      "Ambiente confidencial y respetuoso",
    ],
    featuresEn: [
      "Pap smear screening",
      "Clinical breast exam",
      ...
      "Confidential and respectful setting",
    ],
    highlighted: true,
    order: 8,
  },
