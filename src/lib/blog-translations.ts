...
export const BLOG_TRANSLATIONS: Record<string, BlogTranslation> = {
  "bienvenidos-clinica-hispana-airline": {
    titleEn: "Welcome to Clínica Hispana Airline!",
    descriptionEn: "Discover our Hispanic medical clinic in Houston, TX. Professional care in Spanish, affordable prices, and a team committed to your health.",
    categoryEn: "Announcements",
    keywordsEn: ["Hispanic clinic Houston", "Spanish speaking doctor Houston", "Hispanic doctor Houston TX", "medical care in Spanish Houston", "walk-in clinic Houston"],
    contentEn: `
...
*The Clínica Hispana Airline team*
  ...
  "guia-examen-medico-inmigracion-i693-houston": {
    titleEn: "Complete Guide: I-693 Immigration Medical Exam in Houston TX",
    descriptionEn: "Everything you need to know about the I-693 medical exam for a Green Card in Houston TX. Requirements, vaccines, costs, documents, and what to expect from USCIS-certified Civil Surgeons.",
    categoryEn: "Immigration",
    keywordsEn: ["immigration medical exam Houston", "I-693 exam Houston TX", "civil surgeon Houston", "Green Card medical exam Houston", "USCIS medical exam Houston"],
    contentEn: `
...
*This article is for informational purposes only and does not constitute legal advice. Consult a licensed immigration attorney for questions about your specific case.*
  ...
  "control-diabetes-houston-guia-pacientes": {
    titleEn: "Diabetes Management in Houston: A Guide for Hispanic Patients",
    descriptionEn: "Learn how to manage your diabetes with our comprehensive guide. Glucose monitoring, diet, medications, and how Clínica Hispana Airline can help Houston patients.",
    categoryEn: "Health",
    keywordsEn: ["diabetes management Houston", "Spanish speaking diabetes doctor Houston", "A1C test Houston", "type 2 diabetes Houston", "diabetes treatment Houston TX"],
    contentEn: `
...
*Remember: managing diabetes is a team effort between you and your doctor.*
  ...
  "salud-mujer-houston-servicios-ginecologia": {
    titleEn: "Women's Health in Houston: Gynecology Services in Spanish",
    descriptionEn: "Gynecology services in Houston TX with Spanish-speaking staff. Pap smears, pelvic exams, family planning, and more at Clínica Hispana Airline.",
    categoryEn: "Women's Health",
    keywordsEn: ["gynecology Houston", "Pap smear Houston", "women's health Houston TX", "Spanish speaking gynecologist Houston", "pelvic exam Houston"],
    contentEn: `
...
*Caring for the health of Hispanic women in Houston.*
  ...
  "laboratorio-clinico-houston-analisis-sangre": {
    titleEn: "Clinical Laboratory in Houston: Blood Tests with Same-Day Results",
    descriptionEn: "Clinical laboratory in Houston TX with same-day results. Blood tests, glucose, cholesterol, thyroid panel, and more at affordable prices with Spanish-speaking staff.",
    categoryEn: "Diagnostics",
    keywordsEn: ["clinical laboratory Houston", "blood test Houston", "same day lab results Houston", "blood work Houston TX", "affordable lab tests Houston"],
    contentEn: `
...
*Fast results, Spanish-language care, fair prices.*
  ...
  "atencion-medica-sin-seguro-houston": {
    titleEn: "Healthcare Without Insurance in Houston: Affordable Options",
    descriptionEn: "No health insurance in Houston? Discover affordable, quality medical care options at Clínica Hispana Airline — transparent pricing, no appointment needed.",
    categoryEn: "Information",
    keywordsEn: ["doctor without insurance Houston", "affordable healthcare Houston", "no insurance clinic Houston", "cheap doctor Houston TX", "uninsured medical care Houston"],
    contentEn: `
...
export function getBlogTranslation(slug: string) {
  return BLOG_TRANSLATIONS[slug];
}
